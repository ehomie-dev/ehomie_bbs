...
<div class="plc cl">
	...
	<span class="avatar"><img style="height:35px;width:35px;" src="<!--{if $_G[uid]}--><!--{avatar($_G[uid], small, true)}--><!--{else}--><!--{avatar(0, small, true)}--><!--{/if}-->" /></span>  
	<div class="pi">
		<ul class="fastpost">
