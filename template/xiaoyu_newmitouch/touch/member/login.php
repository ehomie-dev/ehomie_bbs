...
<!-- userinfo start -->
<div class="loginbox  xiaoyu_loginbox <!--{if $_GET[infloat]}-->login_pop<!--{/if}-->">
	<!--{if $_GET[infloat]}-->
	...
	<div class="btn_login"><button tabindex="3" value="true" name="submit" type="submit" class="formdialog pn pnc orange"><span>{lang login}</span></button></div>
	</form>
