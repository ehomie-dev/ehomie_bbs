...
0
|| checktplrefresh('./template/mistyle/forum/guide.htm', './template/default/forum/guide_list_row.htm', 1484854519, '2', './data/template/2_2_forum_guide.tpl.php', './template/mistyle', 'forum/guide')
;?>
<?php if($_GET['inajax']) { ?>
  <?php include template('common/header'); ?>    <ul class="threads-ul"><?php $i=0;?>    <?php if(is_array($data)) foreach($data as $key => $list) { ?>      <?php if($list['threadcount']) { ?>
