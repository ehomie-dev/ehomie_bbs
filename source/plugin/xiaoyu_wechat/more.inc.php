...
$s = str_replace($find, $replace, dfsockopen('http://addon.discuz.com/?@8707.developer'));

global $_G;
$charset = $_G['charset'] ? strtoupper($_G['charset']) : strtoupper(CHARSET);
echo '<style type="text/css">#header,.a_tb,.a_wp .share,.devcat{display:none!important;}</style>';
